...
@section('content')
        ...
        <div class="card" style="padding: var(--space-6); background: white; border-radius: var(--radius-xl); border: 1px solid var(--color-border-light);">
            ...
            <form action="#" method="POST">
                ...
                <div class="form-group" style="margin-bottom: var(--space-4);">
                    ...
                    <input type="text" class="form-control" value="Bookverse" placeholder="Nhập tên nhà sách">
                </div>
                
                <div class="form-group" style="margin-bottom: var(--space-4);">
                    <label class="form-label">Email hỗ trợ</label>
                    <input type="email" class="form-control" value="support@bookverse.vn" placeholder="email@example.com">
                </div>
    ...
    <div class="card" style="margin-top: var(--space-6); padding: var(--space-6); background: white; border-radius: var(--radius-xl); border: 1px solid var(--color-border-light);">
        ...
        <div class="form-group" style="margin-bottom: var(--space-4);">
            ...
            <input type="text" class="form-control" value="Bookverse - Hiệu sách trực tuyến số 1 Việt Nam">
        </div>

        <div class="form-group">
            <label class="form-label">Meta Description mặc định</label>
            <textarea class="form-control" rows="2">Chào mừng bạn đến với Bookverse. Chúng tôi cung cấp hàng ngàn đầu sách đa dạng từ kinh tế, văn học đến kỹ năng sống.</textarea>
        </div>
    </div>
@endsection
