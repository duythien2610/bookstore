{{-- Chatbot Widget — Bookverse AI Assistant --}}
<div id="chatbot-widget">
    ...
    {{-- Toggle Button --}}
    <button class="chatbot-toggle" id="chatbot-toggle" title="Trợ lý AI Bookverse" aria-label="Mở trợ lý AI">
        ...
        <div class="chatbot-messages" id="chatbot-messages">
            <div class="chatbot-msg bot">
                ...
                <div class="chatbot-msg-bubble">
                    Xin chào! 👋 Tôi là trợ lý AI của <strong>Bookverse</strong>. Tôi có thể giúp bạn tìm sách, gợi ý sách hay hoặc trả lời câu hỏi. Bạn cần gì nào?
