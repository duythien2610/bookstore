...
class GoogleController extends Controller
{
    ...
    {
        try {
            // Trong môi trường dev, `stateless()` tránh lỗi mismatch do session/cookie bị đổi
            // (ví dụ sau khi bạn thay `.env` và APP_KEY).
            ...
            // Lỗi OAuth thường bị nuốt vì code đang trả thông báo chung.
            // Log để xác định chính xác nguyên nhân (state mismatch, redirect_uri mismatch, invalid_grant, ...).
